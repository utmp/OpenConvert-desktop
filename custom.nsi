...
SectionGroup "Converters" converters
    Section "Audio and video" ffmpeg
        ...
        inetc::get /caption "ffmpeg" /popup "" "https-link" "$INSTDIR\ffmpeg.7z" /end ;edit https-link to file url
    ...
    Section "Image" libvips
        AddSize 417792
        SetOutPath "$INSTDIR\bin"
        inetc::get /caption "libvips" /popup "" "https-link" "$INSTDIR\libvips.7z" /end ;edit https-link to file url
